...
done < <(docker images --format '{{.Repository}}:{{.Tag}}' | grep -E 'apecloud/kubernetes-airgap:|apecloud/calico-airgap:|labring/helm:|labring/metrics-server:|labring/openebs:|labring/coredns:' || true)
